"""Keyboard protocol negotiation and fallback lifecycle management."""
...
from pana.tui.keys import set_enhanced_keyboard_protocol_active
...
class KeyboardProtocolController:
    """Own keyboard enhancement negotiation with xterm fallback."""
